...
help:
	...
	@echo "  make <target>"
	@echo ""
	@echo "00. Defaults / End-to-end:"
	@echo "  help                                  - Show this help message"
	@echo "  all                                   - Build all PDFs via nbconvert (end-to-end)"
	@echo "  env                                   - Create/update env from environment.yml (end-to-end)"
	@echo "  test                                  - TODO placeholder"
	@echo ""
	@echo "01. Conda environment (primitives):"
	...
	@echo "  env-deactivate                        - Deactivate current env"
	@echo "  env-list                              - List conda envs"
	@echo "  env-list-packages                     - List packages in current env"
	@echo "  env-remove                            - Remove env $(ENV_NAME)"
	@echo ""
	@echo "02. Conda environment (composites):"
	@echo "  all-env-create-from-scratch-once      - One-time bootstrap: create env, install basics, export yml, create kernel, then remove env"
	@echo "  all-env-create-from-yml               - Create/update env from environment.yml, pip install -e ., install kernel"
	@echo ""
	@echo "03. Jupyter kernel:"
	@echo "  ker-create                            - Install IPython kernel for $(KERNEL)"
	@echo "  ker-list                              - List Jupyter kernels"
	@echo "  ker-remove                            - Remove IPython kernel for $(KERNEL)"
	@echo ""
	@echo "04. Project directories:"
	@echo "  dir-create-binder                     - Create binder/ + stub files"
	@echo "  dir-delete-binder                     - Delete binder/"
	@echo "  dir-create-data                       - Create data/ + subdirs"
	@echo "  dir-delete-data                       - Delete processed/vectorized data subdirs"
	@echo "  dir-create-docs                       - Create docs/"
	@echo "  dir-delete-docs                       - Delete docs/"
	@echo "  dir-create-misc                       - Create misc/"
	@echo "  dir-delete-misc                       - Delete misc/"
	@echo "  dir-create-notebooks                  - Create notebooks/ + step00..step05 notebooks"
	@echo "  dir-delete-notebooks                  - Delete notebooks/"
	@echo "  dir-create-fig-builds                 - Create fig_builds/ + step00..step05 subdirs"
	@echo "  dir-delete-fig-builds                 - Delete fig_builds/"
	@echo "  dir-create-pdf-builds                 - Create pdf_builds/ + step00..step05 subdirs"
	@echo "  dir-delete-pdf-builds                 - Delete pdf_builds/"
	@echo "  dir-create-src                        - Create src/ + step00..step05 .py files"
	@echo "  dir-delete-src                        - Delete src/"
	@echo "  dir-create-tests                      - Create tests/ + step00..step05 tests"
	@echo "  dir-delete-tests                      - Delete tests/"
	@echo "  all-dir-create                        - Create all required directories"
	@echo "  all-dir-remove                        - Remove all required directories"
	@echo ""
	@echo "05. Jupytext pairing:"
	@echo "  nb-pair-step00-py                     - Pair step00_utils.py -> step00_utils.ipynb"
	@echo "  nb-pair-step00-ipynb                  - Pair step00_utils.ipynb -> step00_utils.py"
	@echo "  nb-pair-step01-py                     - Pair step01_data.py -> step01_data.ipynb"
	@echo "  nb-pair-step01-ipynb                  - Pair step01_data.ipynb -> step01_data.py"
	@echo "  nb-pair-step02-py                     - Pair step02_eda.py -> step02_eda.ipynb"
	@echo "  nb-pair-step02-ipynb                  - Pair step02_eda.ipynb -> step02_eda.py"
	@echo "  nb-pair-step03-py                     - Pair step03_features.py -> step03_features.ipynb"
	...
	@echo ""
	@echo "06. Docs / site / exports:"
	@echo "  doc-ai-documentation                  - Generate ai_documentation.txt template"
	@echo "  doc-contribution-statement            - Generate contribution_statement.md template"
	@echo "  doc-license                           - Create LICENSE file"
	@echo "  doc-pyproject-toml                    - Create pyproject.toml file"
	@echo "  doc-myst-site-local-start             - Run myst start"
	@echo "  doc-myst-site-init                    - Run myst init"
	...
	@echo "  doc-nbconvert-step01-data-to-pdf      - Build step01_data.pdf"
